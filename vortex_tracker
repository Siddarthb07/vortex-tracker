...
# Constants
PIXELS_PER_CM = 566 / 2.5  # ≈ 226.4 pixels/cm

# Path to the folders
folder_path = r"" #folder path of images
project_folder = r"" #folder path to save geenrated images
...
def measure_diameter(image):
    ...
    _, thresh = cv2.threshold(blur,68,255, cv2.THRESH_BINARY_INV) #treshold values
